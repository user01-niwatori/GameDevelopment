...
/*
 * 参考URL
 * https://note.com/suzukijohnp/n/n3ba0969ea002 
 */
...
/// カメラの複数アスペクト比対応（2D）
/// </summary>
public class CameraAspectRatio2D : MonoBehaviour
{
    /// <summary>
    /// 画面縦比率
    /// </summary>
    ...
    {
        var scaleWidth = (Screen.height / m_baseHeight) * (m_baseWidth / Screen.width);
        var scaleHeight = (Screen.width / m_baseWidth) * (m_baseHeight / Screen.height);
